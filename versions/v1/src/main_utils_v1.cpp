...
Config leerParametros(int argc, char* argv[]) {
    ...
    cfg.min_dias_libres_consec = stoi(argv[6]);
    cfg.max_dias_libres_consec = stoi(argv[7]);
    cfg.min_dias_trab_consec = stoi(argv[8]);
    cfg.max_dias_trab_consec = stoi(argv[9]);
...
vector<Empleado> generarEmpleados_v1(int n) {
