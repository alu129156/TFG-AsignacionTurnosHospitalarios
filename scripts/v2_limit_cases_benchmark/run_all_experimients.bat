...
call ..\postprocessing\postprocessing.bat heuristic_Astar_3_limit_cases_benchmark heuristic_tabuSearch_limit_cases_benchmark HeuristicAstar3-HeuristicTabuSearch_limit_cases_benchmark %IMAGES_FOLDER% v2 1 1
